...
/// Validates IBAN structure and mod-97 checksum per ISO 13616.
///
/// Returns `true` only if [iban] has already been normalized.
bool isValidIban(String iban) {
  if (iban.length < 15 || iban.length > 34) return false;
  if (!_ibanShape.hasMatch(iban)) return false;
